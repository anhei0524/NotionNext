...
const BLOG = {
  AUTHOR: 'river', // 作者
  BIO: '一个普通的干饭人🍚', // 作者简介
  LINK: 'https://study.211888.xyz', // 网站地址
  KEYWORDS: 'Notion, 博客', // 网站关键词 英文逗号隔开
  NOTION_PAGE_ID:
  process.env.NOTION_PAGE_ID || '52af48833bb44b639326fb5fc8c7e77c', // Important page_id！！！Duplicate Template from  https://www.notion.so/tanghh/02ab3b8678004aa69e9e415905ef32a5
  ...
  CONTACT_EMAIL: 'river@211888.xyz',
  CONTACT_WEIBO: '',
  CONTACT_TWITTER: '',
  CONTACT_GITHUB: 'https://github.com/anhei0524',
  CONTACT_TELEGRAM: '',
  ...
  COMMENT_GITALK_OWNER: process.env.NEXT_PUBLIC_COMMENT_GITALK_OWNER || 'anhei0524', // 你的用户名 e.g tangly1024
  COMMENT_GITALK_ADMIN: process.env.NEXT_PUBLIC_COMMENT_GITALK_ADMIN || 'anhei0524', // 管理员用户名、一般是自己 e.g 'tangly1024'
  ...
  TITLE: process.env.NEXT_PUBLIC_TITLE || 'river BLOG', // 站点标题 ，被notion中的页面标题覆盖
  DESCRIPTION:
